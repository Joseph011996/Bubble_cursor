...
class Application(tk.Frame):
    def __init__(self, master=None):
        ...
        object_num = 20  # total number of distractors
        ...
        # self.cursor = area_cursor.AreaCursor(self.canvas, objects) # This calls the Area Cursor Function
        self.cursor = bubble_cursor.BubbleCursor(self.canvas, objects) # This calls the Bubble Cursor Function.
        self.object_index = 0
